 ...
 * @Date: 2024-09-20 10:25:14
 * @LastEditors: Flying_pigs 3051244658@qq.com
 * @LastEditTime: 2024-09-20 11:07:58
 * @FilePath: \admin_vue_lt\src\views\demo\components\voltage-button.vue
 * @Description: 按钮组件
 * 
...
<template>
    ...
    <button @click="clickEvents">Button</button>
