 ...
 * @Date: 2024-10-23 19:19:35
 * @LastEditors: Flying_pigs 3051244658@qq.com
 * @LastEditTime: 2024-10-23 19:30:49
 * @FilePath: \surprisingly_lt\src\views\demo\components\empty-snail-button.vue
 * @Description:
 *
 * Copyright (c) 2024 by ${git_name_email}, All Rights Reserved.
-->
<template>
  <div class="empty-snail-button">
    <label class="switch">
      <input type="checkbox" checked="checked" @click="clickEvents">
      <div class="button">
        <div class="light" />
        <div class="dots" />
