...
<template>
  <CommonPage>
    ...
    <n-button v-show="isGoBackShow" style="position: absolute; top: 17%; left: 15%;" type="primary" @click="goBack">
      返 回
    </n-button>
  </CommonPage>
</template>
...
const isGoBackShow = ref(false) // 控制返回按钮是否显示
const mapList = ref([]) // 记录地图下钻的数据
...
function initializeMap(mapName, mapJSON) {
